    ...
    return (
        <div style={{ background: "whiteSmoke" }}><br />
            ...
            <div style={{ display: 'flex' }}>
                <div id="onhover" >
                    <div className="card border-0 shadow" style={{ width: '35vw', margin: "3rem", marginBottom: "0rem", padding: "2rem", textAlign: 'left', }}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div >
                    <div style={{ width: "0.2rem", height: "10vh", background: "rgba(0,109,184,255)", marginLeft: "6rem" }}></div>
                    ...
                    <div style={{ width: "0.2rem", height: "30vh", background: "rgba(0,109,184,255)", marginLeft: "6rem" }}></div>
                </div>
                <div id="onhover">
                    <div className="card border-0 shadow" style={{ width: "38vw", margin: "3rem", padding: "3rem", textAlign: 'left', marginTop: "4rem" }}>
